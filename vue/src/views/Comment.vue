<template>
  <div style="padding: 10px 20px">
    ...
    <el-table :data="tableData" border stripe style="width: 1150px" size="mini"
      ...
      <el-table-column prop="context" label="内容"  width="400px"> </el-table-column>
      <el-table-column prop="belongid" label="所属id" > </el-table-column>
      ...
      <el-table-column prop="active" label="评论">
